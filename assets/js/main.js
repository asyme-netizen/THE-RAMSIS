    ...
    <div class="auth-overlay" data-auth-overlay aria-hidden="true">
      <div class="auth-modal" role="dialog" aria-modal="true" aria-labelledby="ramsisAuthHeading">
        <section class="auth-shell">
          <aside class="auth-editorial">
            <div class="auth-editorial-inner">
              <div class="auth-kicker">The sovereign editorial</div>
              <div class="auth-brand">THE RAMSIS</div>
              <h2 class="auth-editorial-title">Sign in</h2>
              <p class="auth-editorial-copy">Access the curated archives and global intelligence of The Ramsis editorial desk.</p>
            ...
            <div class="auth-forms">
              <form class="auth-form active" data-auth-form="signin">
                ...
                <div class="auth-field">
                  <label for="ramsisSignInEmail">Corporate email</label>
                  <input id="ramsisSignInEmail" type="email" name="email" placeholder="name@theramsis.com" required>
                </div>
                <div class="auth-field">
                  <label for="ramsisSignInPassword">Credential key</label>
                  <input id="ramsisSignInPassword" type="password" name="password" placeholder="••••••••" required>
                </div>
                <div class="auth-meta-row">
                  <label class="auth-checkbox"><input type="checkbox" name="remember"><span>Remember station</span></label>
                  <button class="auth-forgot" type="button" data-auth-forgot>Forgot password</button>
                </div>
                <button class="auth-submit" type="submit">Authenticate access</button>
                <div class="auth-divider auth-divider-compact">or</div>
              ...
              <form class="auth-form" data-auth-form="signup">
                ...
                <div class="auth-row">
                  <div class="auth-field"><label for="ramsisRegisterPassword">Credential key</label><input id="ramsisRegisterPassword" type="password" name="password" placeholder="At least 6 characters" required></div>
                  <div class="auth-field"><label for="ramsisConfirmPassword">Confirm key</label><input id="ramsisConfirmPassword" type="password" name="confirmPassword" placeholder="Repeat password" required></div>
                </div>
