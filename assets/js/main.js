...
document.addEventListener("DOMContentLoaded", () => {
          ...
          <div class="auth-forms">
            <form class="auth-form active" data-auth-form="signin">
              ...
              <div class="auth-socials">
                ...
                <button type="button" class="auth-social auth-social-disabled" data-social="apple" disabled title="Apple sign-in is not enabled yet"><span></span><span>Apple soon</span></button>
              </div>
  ...
  document.querySelectorAll(".auth-social").forEach((button) => {
    button.addEventListener("click", async () => {
      ...
      if (social === "apple") {
        setMessage(activeTab, "Apple sign-in is not enabled yet in Firebase. Use Google or email/password.", "info");
        return;
      }
