      ...
      <div class="auth-modal" role="dialog" aria-modal="true" aria-labelledby="ramsisAuthHeading">
        ...
        <div class="auth-shell">
          <section class="auth-panel auth-panel-single">
            <div class="auth-brandbar compact"><div class="auth-brand">THE RAMSIS</div></div>
            <div class="auth-kicker-label">THE SOVEREIGN EDITORIAL</div>
            <div class="auth-forms">
              <form class="auth-form active" data-auth-form="signin">
                <h3 id="ramsisAuthHeading">Sign In</h3>
                <p>Access the curated archives and global intelligence of The Ramsis editorial desk.</p>
                ...
                <div class="auth-utility-row">
                  <label class="auth-check"><input type="checkbox" name="remember" checked> <span>Remember station</span></label>
                ...
                <div class="auth-or-sep"><span>or</span></div>
                <button class="auth-request-btn" type="button" data-switch-tab="signup">Request new credentials</button>
              ...
              <form class="auth-form" data-auth-form="signup">
                ...
                <div class="auth-field"><label for="ramsisRegisterEmail">Email</label><input id="ramsisRegisterEmail" type="email" name="email" placeholder="name@theramsis.com" required></div>
                <div class="auth-row">
            ...
            <div class="auth-panel-footer">© 2024 THE RAMSIS. ARCHIVING THE MODERN WORLD.</div>
          </section>
          <section class="auth-visual">
            <div class="auth-visual-overlay">
              <div class="auth-visual-quote-block">
                <div class="auth-visual-rule"></div>
                <blockquote class="auth-visual-quote">“History is not merely the past, it is the lens through which we decrypt the present chaos.”</blockquote>
                <div class="auth-visual-attribution">
                  <span class="auth-visual-role">CHIEF EDITOR</span>
                  <span class="auth-visual-org">THE RAMSIS ARCHIVE</span>
                </div>
              </div>
            </div>
          </section>
...
function bindAuthUI() {
  ...
  qs("[data-forgot-password]")?.addEventListener("click", async () => {
    ...
    if (!email) return setMessage("signin", "Enter your email first, then click Forgot password.", "error");
    try {
  ...
  qs('[data-auth-form="signup"]')?.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      setMessage("signup", "Account created successfully. Signing you in…", "success");
      closeAuth();
    } catch (error) {
        ...
        <div class="account-menu" data-account-menu>
          ...
          <div class="account-dropdown">
            ...
            <div class="account-switcher-panel">
              <div class="account-switcher-head">Switch account</div>
