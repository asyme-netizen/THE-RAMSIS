        ...
        <div class="auth-shell">
          <section class="auth-visual">
            <div class="auth-visual-inner">
              ...
              <div class="auth-logo">THE RAMSIS</div>
              <h2 class="auth-visual-title">Sign in</h2>
              <p class="auth-visual-copy">Access the curated archives and global intelligence of The Ramsis editorial desk.</p>
              <div class="auth-visual-footer">© <span data-year></span> THE RAMSIS. ARCHIVING THE MODERN WORLD.</div>
            </div>
          </section>
          <section class="auth-panel auth-panel-single">
            ...
            <div class="auth-forms">
              <form class="auth-form active" data-auth-form="signin">
                ...
                <div class="auth-switch">Need a reader account? <button type="button" data-switch-tab="signup">Request new credentials</button></div>
