        ...
        <div class="auth-modal-grid">
          <section class="auth-hero-panel">
            <div class="auth-hero-inner">
              <div class="auth-hero-brand">THE RAMSIS</div>
              <div class="auth-hero-kicker">The sovereign editorial</div>
              <h2 class="auth-hero-title">Sign in</h2>
              <p class="auth-hero-copy">Access the curated archives and global intelligence of The Ramsis editorial desk.</p>
              <div class="auth-hero-footer">© 2026 THE RAMSIS. ARCHIVING THE MODERN WORLD.</div>
            </div>
          </section>
          <section class="auth-stage-panel">
            <div class="auth-stage-visual">
              <div class="auth-stage-quote-mark"></div>
              <blockquote>“History is not merely the past, it is the lens through which we decrypt the present chaos.”</blockquote>
              <span>Chief editor — THE RAMSIS ARCHIVE</span>
            </div>
            <div class="auth-card-shell">
              <div class="auth-brandbar"><div class="auth-brand">THE RAMSIS</div></div>
              ...
              <div class="auth-forms">
                <form class="auth-form active" data-auth-form="signin">
                  ...
                  <div class="auth-options-row">
                    ...
                    <button class="auth-text-link" type="button" data-auth-forgot>Password reset</button>
                  </div>
                ...
                <form class="auth-form" data-auth-form="signup">
                  ...
                  <p>Establish your Ramsis reader credentials and your profile will follow you across the site.</p>
                  <div class="auth-socials"><button type="button" class="auth-social" data-social="google"><span>G</span><span>Continue with Google</span></button></div>
                  <div class="auth-divider">or continue with email</div>
                  <div class="auth-row">
                    <div class="auth-field"><label for="ramsisFirstName">First name</label><input id="ramsisFirstName" type="text" name="firstName" placeholder="First name" required></div>
                    <div class="auth-field"><label for="ramsisLastName">Last name</label><input id="ramsisLastName" type="text" name="lastName" placeholder="Last name" required></div>
                  </div>
                  <div class="auth-field"><label for="ramsisRegisterEmail">Corporate email</label><input id="ramsisRegisterEmail" type="email" name="email" placeholder="name@theramsis.com" required></div>
                  <div class="auth-row">
                    <div class="auth-field"><label for="ramsisRegisterPassword">Credential key</label><input id="ramsisRegisterPassword" type="password" name="password" placeholder="Create password" required></div>
                    <div class="auth-field"><label for="ramsisConfirmPassword">Confirm key</label><input id="ramsisConfirmPassword" type="password" name="confirmPassword" placeholder="Confirm password" required></div>
                  </div>
...
function bindAuthUI() {
  ...
  qs("[data-auth-forgot]")?.addEventListener("click", async () => {
    ...
    if (!email) return setMessage("signin", "Enter your email first, then choose Password reset.", "error");
    try {
          ...
          <div class="account-dropdown">
            ...
            <div class="account-switcher-panel">
              <div class="account-switcher-header">
                ...
                <div class="account-switcher-meta"><strong>${escapeHtml(name)}</strong><small>${escapeHtml(user.email || "")}</small></div>
              </div>
              ...
              <button class="account-switcher-action" type="button" data-open-auth data-auth-view="signin">Add account</button>
              <button class="account-switcher-action danger" type="button" data-auth-logout>Sign out…</button>
            </div>
          </div>
        </div>
      `;
  ...
  function bindAccountMenus() {
    ...
    qsa(".account-switcher-action[data-open-auth]").forEach((button) => {
      button.onclick = (event) => {
        event.preventDefault();
        openAuth(button.dataset.authView || "signin");
      };
    });
  }
